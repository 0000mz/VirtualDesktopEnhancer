...
public:
    ...
    virtual HRESULT STDMETHODCALLTYPE GetWallpaper(HSTRING* wallpaperPath) = 0;
};

MIDL_INTERFACE("A871910E-6CC0-4E65-8B9B-458CE9115E30")
IVirtualDesktop2 : public IUnknown
{
public:
    virtual HRESULT STDMETHODCALLTYPE IsRemote(BOOL * isRemote) = 0;
};
...
MIDL_INTERFACE("4970BA3D-FD4E-4647-BEA3-D89076EF4B9C")
...
public:
    ...
    /*
    HRESULT GetDesktopSwitchIncludeExcludeViews([in] IVirtualDesktop *pTargetDesktop, [out] IObjectArray **ppIncludeViews, [out] IObjectArray **ppExcludeViews);
    HRESULT SetDesktopName([in] IVirtualDesktop* desktop, [in] HSTRING name);
    HRESULT SetDesktopWallpaper([in] IVirtualDesktop* desktop, [in] HSTRING wallpaperPath);
    HRESULT UpdateWallpaperPathForAllDesktops([in] HSTRING wallpaperPath);
    HRESULT CopyDesktopState([in] IApplicationView* target, [in] IApplicationView* source);
    */
};
...
{
public:
    virtual HRESULT STDMETHODCALLTYPE CreateRemoteDesktop(HSTRING name, IVirtualDesktop * *ppNewDesktop) = 0;
    virtual HRESULT STDMETHODCALLTYPE SwitchRemoteDesktop(IVirtualDesktop* pDesktop) = 0;
    virtual HRESULT STDMETHODCALLTYPE SwitchDesktopWithAnimation(IVirtualDesktop* pDesktop) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetLastActiveDesktop(IVirtualDesktop** lastActiveVirtualDesktop) = 0;
};
...
public:
    ...
    virtual HRESULT STDMETHODCALLTYPE RemoteVirtualDesktopConnected(
        IVirtualDesktop* remoteVirtualDesktop) = 0;
};
